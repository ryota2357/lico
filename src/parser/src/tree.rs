...
pub enum Statement<'src> {
    ...
    Assign {
        name: (&'src str, TextSpan),
        accesser: Vec<(Expression<'src>, TextSpan)>,
        expr: (Expression<'src>, TextSpan),
    },
...
pub enum Expression<'src> {
    ...
    IndexAccess {
        expr: (Box<Expression<'src>>, TextSpan),
        accesser: (Box<Expression<'src>>, TextSpan),
    },
    DotAccess {
        expr: (Box<Expression<'src>>, TextSpan),
        accesser: (&'src str, TextSpan),
    },
    Error,
}
...
unit_object!(
    #[derive(Clone, Debug, PartialEq)]
    TableObject <=> Vec<((Expression<'src>, TextSpan), (Expression<'src>, TextSpan))>
);
